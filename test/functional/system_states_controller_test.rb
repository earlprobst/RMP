...
#-----------------------------------------------------------------------------
#
# Filename: system_states_controller_test.rb
#
#-----------------------------------------------------------------------------
...
class SystemStatesControllerTest < ActionController::TestCase
  ...
  def setup
    ...
    # Resources urls
    @url="/gateways/#{@gateway.serial_number}/system_states.xml"
  end
  ...
  def test_get_gateway_system_state_xml_by_project_user
  ...
  def test_get_gateway_system_state_xml_with_wrong_authentication
